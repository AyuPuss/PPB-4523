...
public class CuciBasahActivity extends AppCompatActivity {
    ...
    private void setContentView(int activity_laundry) {
    }
    ...
    private void setInitLayout() {
        ...
        imageAdd5 = GambarMin5.findViewById(R.id.imageAdd5);
        ...
        Info.setText("Cuci basah merupakan proses pencucian pakaian biasa menggunakan air dan deterjen.");
    }

    private ContentInfo getIntent() {
        return null;
    }
